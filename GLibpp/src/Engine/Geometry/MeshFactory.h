...
public:
	...
	static Mesh CreateNet(uint32_t size = 1, float distort = 0.0f);
	static Mesh CreateNetWave(uint32_t size = 1, float waveHeight = 0.5f, float time = 0.0f, float speed = 1.0f);
