...
namespace Render {
    ...
    public:
        ...
        void runLoop()
        {
            ...
            TimeManager timer1Hz(1.0); // pro v�po�et FPS ka�dou sekundu
            ...
            while (running.isRunning())
            {
                ...
                {
                    // 1. Zjist�me p�esn� �asov� zna�ky obou stav� z Triple Bufferu
                    double timePrev = logicStatePrevious.tickInfo.lastLogicTick;
                    double timeCurr = logicStateCurrent.tickInfo.lastLogicTick;

                    // 2. Skute�n� �asov� rozd�l mezi stavy (chr�n�me proti d�len� nulou)
                    ...
                    // 3. Vypo��t�me Vizu�ln� �as = aktu�ln� �as m�nus jedno logick� okno
                    // T�m se v�dy dr��me bezpe�n� MEZI timePrev a timeCurr
                    ...
                    // 4. V�po�et alfa na z�klad� skute�n�ho rozp�t�
                ...
                // 1. Zm���me �as, kter� zabral rendering (p�id� se do m_accumulator)
                timerSyncV.tick();

                // 2. Usp�me vl�kno, dokud m_accumulator nedos�hne hodnoty m_fixedDelta (nap�. 33.3 ms)
                ...
                // 3. Ode�teme m_fixedDelta z akumul�toru, aby byl p�ipraven na dal�� sn�mek
                // Pr�zdn� lambda funkce funguje jako "�isti�"
