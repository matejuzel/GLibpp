...
public:
    ...
    double getLowPercentile(double p) const {
        ...
        // Výpoèet delta èasù z historie timestampù
    ...
    /**
     * Uspí vlákno, pokud do dalšího logického kroku zbývá více èasu než threshold.
     * @param threshold Minimální èas v sekundách, po který má smysl spát (default 1ms).
     */
...
private:
    ...
    // mutable umožòuje modifikaci tmp pole i v const metodách (pro výpoèet percentilu)
